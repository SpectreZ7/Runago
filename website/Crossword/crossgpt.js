function generateCrossword(words) {
  ...
  // Here's an example of how to use the generateCrossword function:
  const puzzle = generateCrossword(['cat', 'dog', 'mouse']);
  
  // The puzzle grid will be a 10x10 array of letters and spaces
  console.log(puzzle);